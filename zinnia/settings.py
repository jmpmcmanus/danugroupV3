...
SAVE_PING_DIRECTORIES = False #getattr(settings, 'ZINNIA_SAVE_PING_DIRECTORIES', bool(PING_DIRECTORIES))
SAVE_PING_EXTERNAL_URLS = False #getattr(settings, 'ZINNIA_PING_EXTERNAL_URLS', True)
...
ENTRY_LOOP_TEMPLATES = getattr(settings, 'ZINNIA_ENTRY_LOOP_TEMPLATES', {})
